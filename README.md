...
### Regenerating symbol dice assets

The custom symbol dice images are generated by:

- `tools/generate_symbol_dice.py`

That script expects Pillow (`PIL`) in your Python environment.
